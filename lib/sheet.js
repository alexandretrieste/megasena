...
async function getAuth() {
  ...
  try {
    ...
    // Use JWT directly - it's the most compatible method
    ...
    // Don't authorize immediately - let it happen lazily when needed
    // This avoids OpenSSL errors during initialization
    return auth;
  } catch (error) {
